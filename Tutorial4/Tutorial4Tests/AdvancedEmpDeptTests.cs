...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new {e, d}).Join(grades, ed => 1, s => 1, (ed, s) => new {ed, s}).Where(eds => eds.ed.e.Sal > eds.s.Losal && eds.ed.e.Sal < eds.s.Hisal).Select(eds => new {eds.ed.e.EName, eds.ed.d.DName, eds.s.Grade}).ToList(); 
